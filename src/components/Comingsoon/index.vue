...
export default {
  ...
  activated() {
    ...
    this.isLoading = true;
    this.axios({
      url: `https://m.maizuo.com/gateway?cityId=${cityId}&pageNum=${this.pageNum}&pageSize=10&type=2&k=2605086`,
      headers: {
        "X-Client-Info": '{"a":"3000","ch":"1002","v":"5.0.4","e":"1599886170284962490155009","bc":"310100"}',
  ...
  methods: {
    ...
    loadMore() {
      ...
      this.isShow = true;
      this.axios({
        url: `https://m.maizuo.com/gateway?cityId=${this.preCityId}&pageNum=${++this.pageNum}&pageSize=10&type=2&k=2605086`,
        headers: {
          "X-Client-Info": '{"a":"3000","ch":"1002","v":"5.0.4","e":"1599886170284962490155009","bc":"310100"}',
          "X-Host": "mall.film-ticket.film.list",
        },
    ...
    handleToTouchEnd(pos) {
      if (pos.y > 30) {
        ...
        this.pageNum++;
        this.axios({
          url: `https://m.maizuo.com/gateway?cityId=${this.preCityId}&pageNum=${this.pageNum}&pageSize=10&type=1&k=4271989`,
          headers: {
